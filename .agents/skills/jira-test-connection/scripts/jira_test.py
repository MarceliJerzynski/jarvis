...
def main():
    # Dynamically locate the configuration file across any active jarvis-* sandboxes
    tmp_base = "/home/node-user/.gemini/tmp"
    found_paths = glob.glob(os.path.join(tmp_base, "jarvis-*", "memory", "jira_config.json"))
    ...
    if not os.path.exists(config_path):
        ...
        print("Please ensure your jira_config.json has been created in your workspace temp directory.")
        sys.exit(1)
